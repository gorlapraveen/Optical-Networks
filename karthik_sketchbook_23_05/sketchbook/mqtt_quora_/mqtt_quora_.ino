...
GPRS.println("AT+CSTT=\"http://broadband.tigo.gt\",\"\",\"\""); // Puts phone into GPRS mode
Serial.println("AT+CSTT=\"http://broadband.tigo.gt\",\"\",\"\"");
...
// Serial.println("AT+CIPSTART=\"TCP\",\"http://mqttdashboard.com\",\"1883\"");
delay(2000);
